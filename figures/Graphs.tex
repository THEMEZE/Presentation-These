...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[
  			...
  			(0,0) rectangle (10.0,3);
  			
    	\draw[line width=0.8ex  ,color=colorFour ,  fill = none] 	
			plot[smooth] file {data/donnee_bord_article_distribution_24-04-2024.table}
			(-10.5,10) edge[] node[shift = {(0,0)} , pos=1, right  , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , color = colorFour  ]{ Boundary profile } (-9,10)
		;
		\draw[line width=1.0ex  ,color=\colorSix ,  fill = none] 	
			plot[] file {data/GHD_bord_article_distribution_24-04-2024.table}
			(-10.5,9) edge[] node[shift = {(0,0)} , pos=1, right , , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , color = colorSix ]{ Fit : T = 560~nK } (-9,9)
		;
...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[
  			...
  			(0,0) rectangle (10.0,3);
  		% \draw[line width=0.8ex  ,color=colorOne ,  fill = none] 	
		% 	plot[smooth] file {data/donnee_1_bord_article_distribution_24-04-2024.table}
		% 	(-10.5,10) edge[] node[shift = {(0,0)} , pos=1, right  , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , color = colorOne  ]{ Boundary profile } (-9,10)
		% ;
    	\draw[line width=0.8ex  ,color=colorFour ,  fill = none] 	
			plot[smooth] file {data/donnee_bord_article_distribution_24-04-2024.table}
			(-10.5,10) edge[] node[shift = {(0,0)} , pos=1, right  , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , color = colorFour  ]{ Boundary profile } (-9,10)
		...
		\draw[line width=0.8ex  ,color=colorSix ,  fill = none] 
		 	plot[smooth] file {data/donnee_selection_1_article_distribution_24-04-2024.table}
		 	(-10.5,9) edge[] node[shift = {(0,0)} , pos=1, right, scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , color = colorSix ]{Selected slice} (-9,9)
		;
    \end{scope}
...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[line width=0.8ex  ,color=colorFour ,  fill = none] 	
			...
			(-10.2,10) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries ]{$\tilde{n}(x)$ } (-8.7,10)
		;
		% \draw[line width=0.8ex  ,color= colorFive,  fill = none] 	
		% 	plot[smooth] file {data/Donnee_2_article_asymetrie_24-04-202.table}
		% 	(-10.2,8) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfserie]{ $\tilde{n}(2 x_s - x)$  } (-8.7,8)
		% ;
		...
		\draw[line width=0.8ex, color=colorFive, fill=none] 	
  			plot[smooth] file {data/Donnee_2_article_asymetrie_24-04-202.table}
    			...
    			node[
      			...
      			right, 
	  			scale = 2 , 
      			font=\bfseries\fontsize{10pt}{10pt}\selectfont,
      			text=colorFive
    		]{$\tilde{n}(2x_s - x)$} 
  			(-8.7,9)
		;

		% \draw[line width=1.5ex  ,color=colorOne,  fill = none , dashed] 	
		% 	plot[] file {data/rho_1_article_distribution_24-04-2024.table}
		% 	(-10.2,9) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , ]{\bf $\ell \rho /\tau $  } (-8.7,9)
		% ;
		
		% \draw[line width=1.5ex  ,color=\colorThree,  fill = none] 	
...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[line width=0.8ex  ,color=colorFour ,  fill = none] 	
			plot[smooth] file {data/Donnee_article_simul_expansion_1_24-04-2024-T-x0.table}
			(-10.2,10) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries ]{$\tilde{n}$ } (-8.7,10)
		;
		% \draw[line width=0.8ex  ,color= colorFive,  fill = none] 	
		% 	plot[smooth] file {data/Donnee_2_article_asymetrie_24-04-202.table}
		% 	(-10.2,8) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfserie]{ $\tilde{n}(2 x_s - x)$  } (-8.7,8)
...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	% 	]{$\tilde{n}(2x_s - x)$} 
  		% 	(-8.7,9);
		\draw[line width=1.7ex  ,color=colorSix,  fill = none ] 	
			plot[] file {data/Pi_1_article_distribution_24-04-2024.table}
			(-10.2,8) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , ]{\bf $\Pi /\tau $  } (-8.7,8)
		;
		\draw[line width=1.5ex  ,color=colorOne,  fill = none , dashed] 	
			plot[] file {data/rho_1_article_distribution_24-04-2024.table}
			(-10.2,9) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , ]{\bf $\ell \rho /\tau $  } (-8.7,9)
...
\begin{tikzpicture}
    ...
    \begin{scope}
		...
		\draw[line width=1.9ex  ,color=colorFive,  fill = none ] 	
			plot[] file {data/GHD_1_article_simul_expansion_1_24-04-2024-T-x0.table}
			(-10.2,7) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , ]{ $n_{\mathrm{GHD}}$  } (-8.7,7)
		;
		\draw[line width=1.7ex  ,color=colorSix,  fill = none ] 	
			plot[] file {data/Pi_1_article_distribution_24-04-2024.table}
			(-10.2,8) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , ]{ $\Pi /\tau $  } (-8.7,8)
		;
		\draw[line width=1.5ex  ,color=colorOne,  fill = none , dashed] 	
			plot[] file {data/rho_1_article_distribution_24-04-2024.table}
			(-10.2,9) edge[] node[shift = {(0,0)} , pos=1, right , scale = 2,  font = \fontsize{10pt}{10pt}\selectfont \bfseries , ]{ $\ell \rho /\tau $  } (-8.7,9)
		;
...
\begin{tikzpicture}
	...
	% Axxes 
	\draw[shift = {(0,-2)}](-10, 0) edge[thick, line width=0.8ex, ->, >=Triangle, color=\colorOne] node[shift = {(0,-1)} , pos=0.5, below , scale = 2,  font = \fontsize{150pt}{10pt}\selectfont \bfseries , color = colorOne ]{ $x~(\mu m)$ } (11, 0);
    \draw [shift = {(-10,0)}]  (0, -2) edge[thick, line width=0.8ex, ->, >=Triangle, color=\colorOne] node[shift = {(-1,0)} , pos=0.5, above , rotate = 90 , scale = 2, font = \fontsize{150pt}{10pt}\selectfont \bfseries , color = colorOne  ]{  $n~({\mu m}^{-1})$ } (0, 12)
...
\begin{tikzpicture}
    ...
    \begin{scope}
    	...
    	\draw[line width=1.5ex  ,color=\colorSix ,  fill = none] 	
			plot[smooth] file {data/GHD_article_distribution_24-04-2024.table}
			(-11.5,9) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{20pt}{19pt}\selectfont \bf $\tau \, n_{\mathrm{\small GHD}}(\tau \ast \cdot - x_0)$ } (-10,9)
		;
		\draw[line width=1.5ex  ,color=\colorFive,  fill = none] 	
		...
		;
		\draw[line width=1.5ex  ,color=\colorFour, dashed , dash pattern=on 10pt off 6pt,  fill = none] 	
			plot[] file {data/rho_article_distribution_24-04-2024.table}
			(-11.5,7) edge[] node[shift = {(0,0)} , pos=1, right ]{\fontsize{20pt}{19pt}\selectfont \bf $\ell \, \rho  $  } (-10,7)
		;
    \end{scope}
