...
\begin{tikzpicture}
            ...
            decoration={
                ...
                mark=at position 0.5 with {
                    \node[
                        color=\colorThree,
                        transform shape
                    ] (my node) {\fontsize{20}{5}\selectfont \bfseries \color{\colorThree} System size $ \leftarrow L \gg \ell $};
                },
            },
            %postaction={decorate},
            color=\colorThree,
            ...
            decoration={
                ...
                mark=at position 0.5 with {
                    \node[
                        color=\colorThree,
                        transform shape
                    ] (my node) {\fontsize{15}{5}\selectfont \bfseries \color{\colorThree} continum of locally homogeneous cells of fluid of size  $ \leftarrow \ell \gg d $};
                },
            },
            %postaction={decorate},
            color=\colorThree,
	...
	\begin{scope}[shift={(0,-9)}]
		...
		(-0.5, 0) edge[{Computer Modern Rightarrow[line cap=round]}-{Computer Modern Rightarrow[line cap=round]}] node[pos = 0.5 , right , shift = {(-0.25 , 0.5 )} , color = \colorOne ]{\fontsize{15}{5}\selectfont \bfseries \color{\colorThree} $d \rightarrow $ the microscopic length scle } (0.5, 0)
		;
...
\begin{tikzpicture}[use Hobby shortcut]
	\begin{scope}[shift={(0,0)}]
		...
		\node[right] at (1.5,2.0) {
  			...
  			\begin{tabular}{c}
    			\textbf{Conservation of the atom number :}\\[0.2cm]
    			$\displaystyle \int dx\, n(x,t) = N$\\[0.5cm]
	...
	\begin{scope}[shift={(0,-4)}]
		...
		\node[right] at (1.5,2.0) {
  			\fontsize{10pt}{12pt}\selectfont
  			\begin{tabular}{c}
    			\textbf{Conservation of total momentum:}\\[0.2cm]
    			$\displaystyle \int dx\, p(x,t) = P$\\[0.5cm]
	...
	\begin{scope}[shift={(0,-8)}]
		...
		\node[right] at (1.5,2.0) {
  			\fontsize{10pt}{12pt}\selectfont
  			\begin{tabular}{c}
    			\textbf{Conservation of total energy :}\\[0.2cm]
    			$\displaystyle \int dx\, e(x,t) = E$\\[0.5cm]
	...
	\begin{scope}[shift={(4.5,5)} , scale = 1.3]
		...
		\begin{scope}[shift={(-4.5,1)} , scale = 1.0]
			...
			\begin{scope}%[overlay]
				\node[] (point) at (4,0.1) {};
	        	\draw[  opacity = 1 ]
		        	(point) edge[line width=0.4ex ,color = \colorFour ,arrows = {Computer Modern Rightarrow[sharp ,length=0.2cm]-} , out = 90 , in = 180  ]node[pos=1, right]{\color{colorFour} \fontsize{20}{10}\selectfont \bfseries \begin{tabular}{c} $\displaystyle \int dx \rho ( x , \theta ; t ) \, \delta \theta = \Pi(\theta) \, \delta \theta  $  \\[0.2cm] \textbf{is conserved} \end{tabular} }($(point) + (2.0cm,2.0cm)$)
             	;
        	\end{scope}
		\end{scope}
...
\begin{tikzpicture}
	...
	\shade[draw = none , inner color = colorFour , outer color=colorTwo, opacity = 0.8 , shading=radial ] 
		(1,1) circle (0.5) node [right]{
			\tikz \draw[](0,0) edge[shift = {(0,1)}, thick, line width=0.3ex , -> ,  >=Stealth , color = colorFour] node [pos = 0.5 , above ]{\fontsize{12pt}{16pt}\selectfont $\theta_1$}  (1,0) ;
			}
	;
	\shade[draw = none , inner color = colorFour , outer color=colorTwo, opacity = 0.8 , shading=radial ] (2,3) circle (0.5) ;
	\shade[draw = none , inner color = colorFive , outer color=colorTwo, opacity = 0.8 , shading=radial ] 
		(5,1) circle (0.5) node [left]{
			\tikz \draw[](0,0) edge[shift = {(-0.1,1)}, thick, line width=0.3ex , -> ,  >=Stealth , color = colorFive] node [pos = 0.5 , above ]{\fontsize{12pt}{16pt}\selectfont $\theta_2$}  (-2,0) ;
			}
	;
	\shade[draw = none , inner color = colorFive , outer color=colorTwo, opacity = 0.8 , shading=radial ] (3,3) circle (0.5) ;
	...
	\begin{scope}[shift = {(4.1,6.2)}]
		...
		;
		\draw[shift = {(0.6,0)}]
			(0,0) edge [thick, line width=0.5ex , <- , >=Stealth , color = colorThree] node [ pos = 1.0 , right ]{\fontsize{12pt}{16pt}\selectfont  \color{colorThree} $\Delta(\theta_1 - \theta_2)$ } (0.5,0) 
		;			
	\end{scope}

	
	\begin{scope}[shift={(2.5,3)} , opacity = 0.5]
    	\draw[
        	fill=colorSix,
       	 	color=colorSix,
       		decorate,
        ...
        decoration={
            ...
            mark=at position 0.5 with {
                \node[
					...
					\fontsize{15}{5}\selectfont \bfseries \color{\colorThree} $ \ell $
				};
            },
        },
        %postaction={decorate},
        ...
        decoration={
            ...
            mark=at position 0.5 with {
                \node[
					...
					\fontsize{10}{5}\selectfont \bfseries \color{\colorFour}  collision 
				};
            },
        },
        %postaction={decorate},
        ...
        decoration={
            ...
            mark=at position 0.5 with {
                \node[
					...
					\fontsize{10}{5}\selectfont \bfseries \color{\colorFour} \begin{tabular}{c} no \\[0.01cm] collision \end{tabular}  
				};
            },
        },
        %postaction={decorate},
...
\begin{tikzpicture}
	...
	\begin{scope}[shift = {(-6,-0)}]
		...
		% }	
		% ;
		\node[]  at (0,6) {\fontsize{15}{5}\selectfont \bfseries \color{\colorFour}  Temperature T};
	\end{scope}
...
\begin{tikzpicture}[use Hobby shortcut]
	...
	\begin{scope}[shift = {(0,-0)}]
		...
		\draw[opacity = 1.0 ]
			...
			(0,0) edge[shift = {(0,2.1)}, line width=0.4ex ,color = colorFour ,arrows = {Computer Modern Rightarrow[sharp ,length=0.2cm]-},  , out = 130, in = 0 ]node[pos=1, left ]{\color{colorFour} \fontsize{10}{10}\selectfont \bfseries  density $n(x)$ }($(0,0) + (-1.0cm,0.75cm)$)
	    ;
	\end{scope}
...
%		\draw[line width=0.8ex, color = colorSix , fill = colorFive , opacity = 0.7 ] (-2.8, 0 ) rectangle (-1,2.3) ; 
		...
		\draw[opacity = 1.0 ]
			...
			(0,0) edge[shift = {(0,2.1)}, line width=0.4ex ,color = colorFour ,arrows = {Computer Modern Rightarrow[sharp ,length=0.2cm]-},  , out = 130, in = 0 ]node[pos=1, left ]{\color{colorFour} \fontsize{10}{10}\selectfont \bfseries  atom restant }($(0,0) + (-1.0cm,0.75cm)$)
	    ;
	\end{scope}
...
\def\listetuple{
	-8.5/{I_{1}}/{-\frac{N-1}2\quad }, -8/{I_{2}}/{} , -7.5/{I_{3}}/{} , -7/{}/{} , -6.5/{}/{} , -6/{}/{} , -5.5/{}/{} , -5/{}/{} , -4.5/{}/{} , -4/{}/{} , -3.5/{}/{} ,  -2.0/{}/{} , -1.5/{}/{} , -1/{}/{} , -0.5/{I_{a}}/{} , 0/{}/{} , 0.5/{}/{} , 1/{}/{} , 1.5/{}/{} , 2/{}/{} , 2.5/{}/{} , 4/{}/{} , 4.5/{}/{} , 5/{}/{} , 5.5/{}/{} , 6/{}/{} , 6.5/{}/{} , 7/{}/{} , 7.5/{}/{} , 8/{}/{} , 8.5/{I_N}/{\frac{N-1}2}
	}
%1
\begin{tikzpicture}
	...
	%\draw[dashed, color=gray!70 , line width=0.8ex] (-14,-3) rectangle (14,20);
	\path (-14,-3) rectangle (14,20);
	%\drawgrid{-14}{14}{-3}{20}
...
\def\listetupletheta{-10/\theta_{1}, -9/\theta_{2} ,  -8/\theta_{3}, -7.5/{} , -7/{} , -6/{}, -5/{} ,  -4/{},  -1.5/{} , -1/\theta_{a} , 0/{} , 0.5/{} , 1/{} , 2/{} , 4/{} , 5/{} , 5.5/{},  6/{}, 6.5/{},  7/{} , 8/{} , 8.5/{}, 9/\theta_{N} }
...
\begin{tikzpicture}
	...
	\begin{scope}[shift={(5,1.8)},rotate=0,opacity=1,color=black]	
		
		\draw[shift={(0,0)} ,line width=1ex,rounded corners = 1ex,color=\colorOne , opacity =1 ,fill=\colorOne!00 , pattern={north east lines} , pattern color=\colorOne!00 ]
			(0 , -1 ) rectangle (8,1)
		;
		
		\node[anchor=west] at (0.5, 0.5) {\color{\colorFour}\large $L\rho (\theta) \delta \theta$ };\node[anchor=west, font=\bfseries] at (2, 0.5) {\color{\colorFour}\large : $\#$ rapiditie $\in [\theta , \theta + \delta \theta $ ]};
		
		\node[anchor=west] at (0.5, -0.5) {\color{\colorFour}\large $L\rho_s (\theta) \delta \theta = \delta I $ };\node[anchor=west, font=\bfseries] at (3.2, -0.5) {\color{\colorFour}\large  : $\#$ states $\in [\theta , \theta + \delta \theta [$};
